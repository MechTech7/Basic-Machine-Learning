...
#this is the URL to the Python Notebook this program is based on
#the objective is to write a python program to download the notMNIST database and be able to serve it to another program
...
print("-------------train_folders: {}".format(train_folders))
print("-------------test_folder: {}".format(test_folders))
...
def convert_to_one_hot(input_arr, depth):
  ...
  return op
def get_train_dataset(train_dataset, train_labels):
...
def get_test_dataset():
  #TODO:reshape the test dataset as well
...
def get_num_train_examples():
  return train_dataset.shape[0]
def get_train_batches(batch_size):
  train_data, train_l = get_train_dataset()
